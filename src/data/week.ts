...
const chickenRice: Meal = {
  time: "12:30",
  name: "มื้อกลางวัน",
  menu: "ข้าวกล้อง + อกไก่ทอดกระทะ + ผัก",
  equipment: ["หม้อหุงข้าว", "กระทะไฟฟ้า", "ไมโครเวฟ"],
  steps: [
    "ข้าว: ตักข้าวกล้องที่เตรียมไว้ใส่จาน อุ่นไมโครเวฟ 1–2 นาที",
    "อกไก่: หั่นชิ้นบาง โรยเกลือ+พริกไทย → กระทะไฟฟ้าไฟกลาง หยอดน้ำมัน 1 ช้อน → ทอด 4–5 นาที/ด้าน จนข้างในไม่มีสีชมพู",
...
const postWorkoutWeights: Meal = {
  ...
  steps: [
    ...
    "อุ่นข้าวกล้อง+อกไก่ที่เตรียมไว้ในไมโครเวฟ 2 นาที (หรือทอดอกไก่สดในกระทะ 4–5 นาที/ด้าน)",
...
const postCardio: Meal = {
  ...
  steps: [
    ...
    "อุ่น/ทอดอกไก่ในกระทะไฟฟ้า 4–5 นาที/ด้าน",
...
const mealPrep: Meal = {
  time: "12:30",
  name: "มื้อกลางวัน (เตรียมของทั้งสัปดาห์)",
  menu: "Meal prep: หุงข้าว + ทอดอกไก่ + ต้มไข่ แบ่งกล่อง",
  equipment: ["หม้อหุงข้าว", "กระทะไฟฟ้า", "เครื่องต้มไข่"],
  steps: [
    "หุงข้าวกล้องหม้อใหญ่ (หม้อหุงข้าว) ตักแบ่ง 5–6 กล่อง พักให้เย็นแล้วแช่ตู้เย็น",
    "ทอดอกไก่ทีละหลายชิ้นในกระทะไฟฟ้า (ไฟกลาง น้ำมัน 1 ช้อน 4–5 นาที/ด้าน) แบ่งกล่อง",
    "ต้มไข่ 7–10 ฟองเก็บไว้ — ทั้งสัปดาห์แค่อุ่นไมโครเวฟก็พร้อมกินทันที",
  ],
  tags: ["เตรียมล่วงหน้า"],
};
