...
export const exerciseCues: Record<string, string[]> = {
  ...
  "Lateral Raise": [
    "ยืนถือดัมเบลข้างลำตัว ฝ่ามือหันเข้า งอศอกนิดเดียวค้างไว้ เกร็งแกนกลาง",
    "กางแขนขึ้นด้านข้างจนข้อศอกอยู่ระดับไหล่ นำด้วยข้อศอก (ไม่ใช่ข้อมือ)",
    "ลดลงช้า ๆ คุมจังหวะ อย่าปล่อยตก",
    "ข้อผิดที่พบบ่อย: ใช้แรงเหวี่ยง/ยักไหล่ — เลือกน้ำหนักเบาลง เน้นรู้สึกที่ไหล่ข้าง",
  ],
  "Plank": [
  ...
  "Side Plank": [
    "ตะแคงข้าง วางศอกใต้หัวไหล่ ขาเหยียดซ้อนกัน ยกสะโพกขึ้นให้ลำตัวเป็นเส้นตรง",
    "เกร็งหน้าท้องด้านข้างและก้น อย่าให้สะโพกตก ค้างตามเวลา",
    "ทำครบแล้วสลับอีกข้าง เวลาเท่ากันทั้งสองข้าง",
  ],
  "Deadlift": [
  ...
  "Standing Calf Raise": [
    "ยืนปลายเท้าบนขอบสเต็ป/แท่น ส้นเท้าลอย ถือดัมเบลหรือใช้เครื่อง เกร็งแกนกลาง",
    "เขย่งส้นเท้าขึ้นสูงสุด บีบน่องค้างแป๊บที่จุดบนสุด",
    "ลดส้นเท้าลงช้า ๆ จนรู้สึกยืดน่องเต็มที่ แล้วเขย่งขึ้นใหม่",
    "ข้อผิดที่พบบ่อย: เด้งเร็ว ระยะสั้น — เคลื่อนเต็มช่วง ขึ้นสุด–ลงสุด คุมจังหวะ",
  ],
  "Hanging Knee Raise": [
  ...
  "Lying Leg Curl": [
    "นอนคว่ำบนเครื่อง วางส้นเท้า/ข้อเท้าใต้แผ่นรอง เข่าเลยขอบเบาะเล็กน้อย",
    "งอเข่าดึงส้นเท้าเข้าหาก้น บีบกล้ามขาหลังที่จุดสูงสุด",
    "ลดลงช้า ๆ จนขาเกือบตึง คุมจังหวะ ไม่ปล่อยกระแทก",
    "ข้อผิดที่พบบ่อย: ยกสะโพกลอย/ใช้แรงเหวี่ยง — กดสะโพกติดเบาะ เคลื่อนแค่ข้อเข่า",
  ],
  ...
  "Face Pull": [
    "ตั้งสายเคเบิลระดับใบหน้า จับเชือกสองมือ ถอยให้สายตึง อกตั้ง",
    "ดึงเชือกเข้าหาหน้าผาก/ข้างหู กางศอกออก บีบสะบักและไหล่หลังเข้าหากัน",
    "ปล่อยกลับช้า ๆ จนแขนตึง คุมจังหวะตลอด",
    "ข้อผิดที่พบบ่อย: ใช้น้ำหนักมากจนกลายเป็น row — เบาไว้ เน้นบีบไหล่หลัง",
  ],
  "Dumbbell Curl": [
    "ยืนถือดัมเบลข้างลำตัว ฝ่ามือหันไปข้างหน้า หนีบศอกชิดลำตัว",
    "ยกขึ้นด้วยกล้ามแขนหน้า บีบไบเซ็ปที่จุดบนสุด ไม่เหวี่ยงตัว",
    "ลดลงช้า ๆ จนแขนตึง คุมจังหวะตลอด",
    "ข้อผิดที่พบบ่อย: เหวี่ยงเอว/แกว่งไหล่ — เลือกน้ำหนักพอเหมาะ ล็อกศอกชิดลำตัว",
  ],
  "Triceps Pushdown": [
    "ยืนหน้าเครื่องเคเบิล จับด้าม/เชือก หนีบศอกชิดลำตัว อกตั้งเล็กน้อย",
    "ดันลงจนแขนตึง บีบกล้ามแขนหลัง (ไทรเซ็ป) ค้างแป๊บ",
    "ปล่อยขึ้นช้า ๆ แค่ระดับศอก คุมจังหวะ ไม่ให้ศอกกาง",
    "ข้อผิดที่พบบ่อย: ศอกกาง/โน้มตัวช่วยดัน — ล็อกศอกชิดลำตัว ใช้แค่แรงไทรเซ็ป",
  ],
};
