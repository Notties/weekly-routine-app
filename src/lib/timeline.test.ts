...
const weightDay: ResolvedDay = {
  ...
  meals: [
    { time: "07:00", name: "เช้า", menu: "a", recipeId: "r1", slot: "breakfast", emoji: "🍽️", ingredients: [], steps: ["1"], tags: [], macros: { kcal: 0, protein: 0, carb: 0, fat: 0 }, benefit: "" },
    { time: "12:30", name: "กลางวัน", menu: "b", recipeId: "r2", slot: "lunch", emoji: "🍽️", ingredients: [], steps: ["1"], tags: [], macros: { kcal: 0, protein: 0, carb: 0, fat: 0 }, benefit: "" },
    {
      time: "20:30",
      name: "หลังเล่น",
      menu: "c",
