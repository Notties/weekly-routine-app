...
export const recipes: Recipe[] = [
...

  {
    id: "bf-tuna",
    emoji: "🐟",
    name: "ขนมปังโฮลวีท + ทูน่าคลุกโยเกิร์ต + กล้วย",
    slot: "breakfast",
    equipment: ["ไม่ต้องปรุง"],
    ingredients: [
      { name: "ขนมปังโฮลวีท", grams: 60 },
      { name: "ปลาทูน่ากระป๋อง", grams: 120 },
      { name: "กรีกโยเกิร์ต", grams: 50 },
      { name: "กล้วยหอม", grams: 100 },
    ],
    steps: [
      "เปิดทูน่ากระป๋อง เทน้ำทิ้งให้สะเด็ด คลุกกรีกโยเกิร์ต 50 ก. + พริกไทย = ทูน่าสเปรดครีมมี่ (ไม่ต้องใช้มายองเนส)",
      "ทาบนขนมปังโฮลวีท 2 แผ่น (อุ่นไมโครเวฟ 15 วิ ถ้าชอบนุ่ม)",
      "ปิดท้ายกล้วย 1 ลูก — เสร็จใน 5 นาที ไม่ใช้ไฟ",
    ],
    benefit:
      "โปรตีนสูงจากปลาแทนมื้อไข่ ได้โอเมกา-3 ดีต่อหัวใจ ตัดคอเลสเตอรอลจากไข่แดงออกทั้งมื้อ",
...

  {
    id: "dn-tofu",
    emoji: "🍲",
    name: "ข้าวกล้อง + เต้าหู้ผัดผัก + แอปเปิล",
    slot: "dinner",
    equipment: ["กระทะไฟฟ้า", "ไมโครเวฟ"],
    ingredients: [
      { name: "ข้าวกล้อง", grams: 150 },
      { name: "เต้าหู้แข็ง", grams: 250 },
      { name: "ผักรวมแช่แข็ง", grams: 100 },
      { name: "น้ำมันรำข้าว", grams: 5 },
      { name: "แอปเปิล", grams: 150 },
    ],
    steps: [
      "เต้าหู้แข็ง 1 ก้อน ซับน้ำ หั่นลูกเต๋า → กระทะไฟฟ้าไฟกลาง น้ำมัน 1 ช้อน ผัดกับกระเทียม+ผักรวม ปรุงซีอิ๊ว 1 ช้อน จนขอบเต้าหู้เหลือง",
      "ตักข้าวกล้องที่หุงไว้ 150 ก. อุ่นไมโครเวฟ 1–2 นาที กินคู่กัน",
      "ปิดมื้อด้วยแอปเปิลหั่น 1 ลูก",
    ],
    benefit:
      "มื้อเย็นคุมคอเลสเตอรอล — เต้าหู้ให้โปรตีนพืชช่วยลด LDL ผัดน้ำมันรำข้าว เบาท้องก่อนนอน",
    tags: ["ดีต่อหัวใจ", "ไม่มีเนื้อสัตว์"],
  },
