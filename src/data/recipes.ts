...
export const recipes: Recipe[] = [
  // ── มื้อเช้า ──
  {
    ...
    steps: [
      ...
      "ใส่ข้าวโอ๊ต ~1/3 ถ้วย (40 ก.) + นมจืด 1 กล่อง ในชามทนไมโครเวฟ อุ่น 2 นาที แล้วคน (ระวังร้อน)",
      "โรยวอลนัท 15 ก. บนโอ๊ต ปอกไข่ กินคู่กล้วยลูกเล็ก (80 ก.)",
    ],
    benefit:
  ...
  // ── มื้อกลางวัน ──
  {
    ...
    steps: [
      "ข้าว: หุงข้าวสวย (หม้อหุงข้าว) ตัก ~140 ก. มื้อนี้ ที่เหลือแบ่งใส่กล่องไว้กินมื้อต่อไป",
  ...
  },
  {
    ...
    steps: [
      "ข้าว: ตักข้าวสวยที่หุงไว้ ~140 ก. อุ่นไมโครเวฟ 1–2 นาที",
  ...
  // ── ของว่าง ──
  {
    ...
    ingredients: [
      ...
      { name: "อัลมอนด์", grams: 12 },
      { name: "นมแคลเซียมสูง", grams: 180 },
    ],
    steps: [
      "ตักกรีกโยเกิร์ต 150 ก. โรยอัลมอนด์ 12 ก.",
...

  {
    ...
    steps: [
      ...
      "ตักข้าวที่หุงไว้ 100 ก. อุ่นไมโครเวฟ กินคู่กัน",
