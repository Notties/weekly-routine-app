...
export const recipes: Recipe[] = [
  // ── มื้อเช้า ──
  {
    ...
    benefit:
      "คาร์บเชิงซ้อนจากโอ๊ตให้พลังงานยาวตลอดเช้า เบต้ากลูแคนในโอ๊ตช่วยลด LDL + โปรตีนจากไข่/นมเริ่มสร้างกล้ามตั้งแต่ตื่น",
  ...
  },
  {
    id: "dn-chicken",
    emoji: "🍗",
    name: "ข้าวสวย + อกไก่ทอดกระทะ + ผัก (อุ่นจากกล่องก็ได้)",
    slot: "dinner",
  ...
  // ── เมนูสลับเพิ่ม (ความหลากหลาย) ──
  {
    ...
    benefit:
      "มื้อเช้าโปรตีนสูง ทำเร็วไม่ต้องใช้ไฟ โอ๊ตให้ไฟเบอร์อิ่มนานและช่วยลด LDL เหมาะวันรีบ",
